...
public class MOTDCommand extends Command {
  ...
  public String getUsage(Lang lang) {
    return "/motd <set> <lineNo.> <msg>...";
  }

  @Override
  public String getDescription(Lang lang) {
    return lang.local.DESCRIPTION_MOTD;
  }
  ...
  public void set(MinecraftServer server, ICommandSender sender, String[] args, Lang senderLang) {
    if (args.length > 1) {
      try {
        ...
        String motd = Strings.join(Arrays.copyOfRange(args, 1, args.length), " ");
        GeneralUtils.setMotdLine(lineNo, motd);
        ChatHelper.sendMessage(
            ...
            senderLang
                ...
                .replaceAll(Replacment.DATA, motd));
