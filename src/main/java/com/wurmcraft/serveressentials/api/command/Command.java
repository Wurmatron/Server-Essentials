...
/**
 * Creates a new Server-Essentials ModuleCommand along with the usage of a custom command handler to
 * allow for ignoring case for all of its commands.
 *
 * @see ModuleCommand for automatic registration with its given module along with custom permission
 *     nodes
...
public abstract class Command {
  ...
  /** The command's name for use in-game /<commandName> automatically ignoring case */
