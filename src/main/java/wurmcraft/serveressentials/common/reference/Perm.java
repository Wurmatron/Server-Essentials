...
public enum Perm {
	...
	// Admin
	SET_WARP ("admin.setWarp"),DEL_WARP ("admin.delWarp"),SET_SPAWN ("admin.setSpawn"),INVSEE ("admin.invsee"),SUDO
		("admin.sudo"),HEAL ("admin.heal"),GAMEMODE ("admin.gameMode"),ADD_RULE ("admin.addRule"),DEL_RULE ("admin" +
		".delRule"),ADD_MOTD ("admin.addMotd"),DEL_MOTD ("admin.delMotd"),TEAM_ADMIN ("admin.teamAdmin"),BROADCAST
		("admin.broadcast"),SKULL ("admin.skull"),DEL_PLAYER_FILE ("admin.delPlayerFile"),RELOAD_PLAYER_DATA ("admin" +
