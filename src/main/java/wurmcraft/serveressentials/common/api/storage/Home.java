...
public class Home {
		...
		public Home(String name, BlockPos location, int dimension, float yaw, float pitch) {
				this.name = setName(name); this.pos = setPos(location); this.dimension = dimension; this.yaw = yaw;
				this.pitch = pitch;
		}
		...
		public String setName(String name) {
				this.name = name.replaceAll("[^a-zA-Z0-9-_\\.]", "_"); return getName();
		}
