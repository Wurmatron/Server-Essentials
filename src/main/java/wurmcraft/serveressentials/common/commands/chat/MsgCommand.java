    ...
    super.execute(server, sender, args);
      if (args.length > 1 && sender != null) {
          ...
          if (reciv != null) {
              ...
              if (sender.getCommandSenderEntity() != null && sender
                  ...
                  sender.sendMessage(new TextComponentString(ConfigHandler.msgFormat
                  ...
                  DataHelper2.addTemp(Keys.LAST_MESSAGE, entitySender.getGameProfile().getId(),
                      reciv.getGameProfile().getId(), false);
              } else {
                  ChatHelper.sendMessageTo(sender, reciv, ConfigHandler.msgFormat
                      .replaceAll(ChatHelper.USERNAME_KEY, TextFormatting.AQUA + "Server")
                      .replaceAll(ChatHelper.MESSAGE_KEY, TextFormatting.GRAY + message));
              }
          } else {
              sender
                  .sendMessage(
                      new TextComponentString(Local.PLAYER_NOT_FOUND.replace("#", args[0])));
          }
      } else {
