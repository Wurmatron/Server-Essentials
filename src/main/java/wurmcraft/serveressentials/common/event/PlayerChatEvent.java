...
public class PlayerChatEvent {
	...
	public void onChat (ServerChatEvent e) {
		...
		if (!DataHelper.isMuted (e.getPlayer ().getGameProfile ().getId ())) {
			...
			ChatHelper.sendMessage (name,DataHelper.getPlayerData (e.getPlayer ().getGameProfile ().getId ()).getRank (),ChannelManager.getPlayerChannel (e.getPlayer ().getGameProfile ().getId ()),e.getPlayer ().dimension,e.getMessage ());
		} else
