    ...
    public static final class Range<T extends Number> {
        ...
        public T difference() {
            switch(this.lower.getClass().getSimpleName()) {
                case "Long": { return(T)new Long(this.upper.longValue() - this.lower.longValue()); }
                case "Float": { return (T)new Float(this.upper.floatValue() - this.lower.floatValue()); }
                case "Integer": { return (T)new Integer(this.upper.intValue() - this.lower.intValue()); }
                default: return (T)new Double(this.upper.doubleValue() - this.lower.doubleValue());
            }
        }
