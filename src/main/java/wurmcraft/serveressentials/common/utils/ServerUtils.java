...
public class ServerUtils {
    ...
    public static class CustomDedicatedPlayerList extends DedicatedPlayerList {
        ...
        public void setDisconnectMessage(String message) { this.disconnectMessage = message; }
        @Override
        public void removeAllPlayers() {
            for (int i = 0; i < getPlayerList().size(); ++i) {
                ((EntityPlayerMP)getPlayerList().get(i)).connection.kickPlayerFromServer(disconnectMessage);
            }
        }
    }
