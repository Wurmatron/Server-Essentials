...
import wurmcraft.serveressentials.common.event.PlayerChatEvent;
import wurmcraft.serveressentials.common.event.PlayerDeathEvent;
...
import wurmcraft.serveressentials.common.event.WorldEvent;
...
public class ServerEssentialsServer {
  ...
  public void init(FMLInitializationEvent e) {
    ...
    DownloadHelper.save(Global.LOCAL_WEB + ConfigHandler.defaultLang + ".lang",
        new File(ConfigHandler.saveLocation + File
            .separator + "Language" + File.separator + ConfigHandler.defaultLang + ".lang"));
  }
