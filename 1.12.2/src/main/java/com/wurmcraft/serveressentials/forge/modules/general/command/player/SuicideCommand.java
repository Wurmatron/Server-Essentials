...
@ModuleCommand(moduleName = "General", name = "Suicide", aliases = {"Seppuku"})
public class SuicideCommand {

  @Command(inputArguments = {})
  public void helpMe(ICommandSender sender) {
    if (SERegistry.isModuleLoaded("Rank") && RankUtils
        .hasPermission(RankUtils.getRank(sender), "general.suicide") || !SERegistry
        .isModuleLoaded("Rank")) {
