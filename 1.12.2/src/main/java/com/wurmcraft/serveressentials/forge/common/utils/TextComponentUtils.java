...
public class TextComponentUtils {
  ...
  public static ITextComponent addPosition(ITextComponent component,
      LocationWrapper loc) {
    component.getStyle().setHoverEvent(new HoverEvent(Action.SHOW_TEXT,
        new TextComponentString(COMMAND_INFO_COLOR + loc.toString())));
    return component;
  }
