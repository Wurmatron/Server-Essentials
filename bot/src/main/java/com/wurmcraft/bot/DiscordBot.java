...
public class DiscordBot {
  ...
  public static void main(String[] args) {
    if (args.length >= 3) {
      baseURL = java.com.wurmcraft.bot.RequestGenerator.parseConfigURL(args[1]);
      auth = "Basic " + args[2];
      ...
      api.addMessageCreateListener(e -> {
        if (e.isPrivateMessage() && e.getMessage().getContent().equalsIgnoreCase("!verify")) {
          ...
          java.com.wurmcraft.bot.RequestGenerator.INSTANCE
      ...
      api.getThreadPool().getScheduler().scheduleAtFixedRate(() -> {
        ...
        Player[] players = ((Players) java.com.wurmcraft.bot.RequestGenerator.INSTANCE
